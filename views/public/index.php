...
<html lang="pt">
	<head>
        ...
        .carousel-slide {
            ...
            animation: fadeSlide 
			<?= count($imagensDestaque) * 5 ?>s infinite;
        }
        
			<?php foreach ($imagensDestaque as $index => $img): ?>
            .carousel-slide:nth-child(
			<?= $index + 1 ?>) {
                animation-delay: 
			<?= $index * 5 ?>s;
            }
      ...
      .catch(err => console.error('SW falhou', err));
		...
		<div>
			...
			<section class="mb-4">
				<h2>Quem Somos</h2>
				<p>
					<strong>Vivemos e respiramos desporto em todas as suas formas.</strong>
            ...
            Se o desporto faz parte da tua vida, este é o teu lugar.
				</p>
			</section>
			<!-- Imagens em Destaque -->
			<section class="mb-4">
				...
				<br>
					...
					<div class="carousel-container">
						...
						<div class="carousel-slide">
							<img src="/public/uploads/destaque/
								<?= htmlspecialchars($img) ?>" alt="Imagem destaque" loading="lazy" />
							</div>
							<?php endforeach; ?>
						</div>
						<?php else: ?>
					...
					<section class="mb-4">
						...
						<br>
							...
							<div class="cards-container">
								...
								<a href="noticia.php?id=
									<?= urlencode($noticia['id']) ?>" class="content-card" tabindex="0">
									<img src="/public/uploads/noticias/
										<?= htmlspecialchars($noticia['imagem']) ?>" alt="Imagem da notícia" loading="lazy" />
							...
							<section class="mb-4">
								...
								<br>
									...
									<div class="cards-container">
										...
										<a href="artigo.php?id=
											<?= urlencode($artigo['id']) ?>" class="content-card" tabindex="0">
											<?php if ($artigo['image']): ?>
											<img src="/public
												<?= htmlspecialchars($artigo['image']) ?>" alt="Imagem do artigo" loading="lazy" />
												<?php endif; ?>
												<div class="content-card-content">
													<h5>
