...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO users (name, birth_date, nationality, country, email, phone, password) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$name, $birth_date, $nationality, $country, $email, $phone, $hash]);
