...
function enviarDenunciaComentario($adminEmail, $comment, $reporterName, $reporterEmail, $reason)
{
    $subject = "Denúncia de Comentário no Site";

    $body = "
        <p><strong>Comentário denunciado:</strong></p>
        <ul>
            <li><strong>Autor:</strong> {$comment['name']}</li>
            <li><strong>Email do autor:</strong> {$comment['email']}</li>
            <li><strong>Comentário:</strong> {$comment['comment']}</li>
        </ul>
        <p><strong>Denúncia feita por:</strong></p>
        <ul>
            <li><strong>Nome:</strong> {$reporterName}</li>
